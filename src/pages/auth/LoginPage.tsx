...
export function LoginPage() {
  const [email, setEmail] = useState('demo@classflow.app')
    ...
    <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Sign in to access your schedule</p>
        </div>
        ...
        <Button variant="outline" className="w-full rounded-xl" type="button" onClick={() => toast.info('Google sign-in is a UI mockup — use email login')}>
